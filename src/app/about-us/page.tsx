...
Seedは、常に顧客の声に耳を傾け、身軽になりたい社長のそばで支えるプロダクトを追求し続けます。今後とも、皆さまのご支援をよろしくお願いいたします。`

const CEO_INTRO = `1998年、千葉県市川市生まれ。2023年、筑波大学大学院情報理工学位プログラム修了(自然言語処理研究)。
在学中よりシステム受託開発に携わり、卒業後は株式会社pluszero(AIスタートアップ)にて4年間、AIモデル研究開発とシステム/AI受託開発、プロジェクトマネジメントを担当。技術とビジネス両方の視点から、業務改善を得意とする。
2024年12月に株式会社Seedを設立し、独自プロダクトKaikaを開発。
主な受賞歴に、全国大学ビジコンファイナリスト / cvg東京大会優秀賞 / 立命館大学学生ベンチャーコンテスト最優秀賞 / MIT-VFJ HIROメモリアル賞。`
