...
const CEO_MESSAGE = `私自身、頭の中には、決めかけた事、誰かに返す事、いつかやりたい事が同じ重さで並んでいました。他人の責任や不安にまでエネルギーを使って、自分の事業に向かう時間が残っていませんでした。
そのため、何を大切にしてきて、どう動いて、何が起きたかを覚えている右腕が必要でした。だからこそ、事業に向き合う社長が、本当に重要なことに集中し、自分の望みから価値を生み出せる環境を実現したいという想いで、Kaikaを開発しました。
